//*Question 19:* Dinner Guests: Use one of your programs from Exercises 14 through 18 to print a message indicating the number of people you are inviting to dinner.
 let guests = ["Fiza","Maheen","Nazia","Ansa","Sana","Anaya","Anabya","Shiza","Hafsa"]

 console.log(`\nI am inviting ${guests.length } guests in dinner.`);
...
let countries = ["Pakistan","Turkey","Japan","Switzerland","Canada"]
...
let book : {title : string , authors : string , yearPublished : number} = {
    title : "Rich Dad and Poor Dad",
    authors : "Robert T.Kiyosaki and Sharon Lechter",
    yearPublished : 1997
}

console.log(`\n${book.title} is a ${book.yearPublished} book written by ${book.authors}.\n`);
